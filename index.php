		...
		<section id="contact" class="dark-bg light-typo padding-top">
			...
			<div class="container">
				...
				<form  id="contact-form" class="bl_form text-center" action="contact.php" method="post" novalidate>
					...
					<p class="text-center"><button  name="submit" type="submit" class="btn btn-meflat icon-left" data-error-message="Error!" data-sending-message="Sending..." data-ok-message="Message Sent"><i class="fa fa-envelope fa-fw"></i>Send Message</button></p>
